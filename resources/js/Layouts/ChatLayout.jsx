...
const ChatLayout = ({ children }) => {
    ...
    const [onlieUsers, setOnlineUsers] = useState({});

    const isUserOnline = (userId) => onlieUsers[userId];
    ...
    useEffect(() => {
        ...
        useEffect(() => {
            window.Echo.join('online')
                .here((users) => {
                    const onlileUsersObj = Object.fromEntries(users.map((user) => [user.id, user]));

                    setOnlineUsers((prevOnlineUsers) => {
                        return { ...prevOnlineUsers, ...onlileUsersObj };
                    });
                })
                .joining((user) => {
                    setOnlineUsers((prevOnlineUsers) => {
        ...
        return (
            <>
                <div className="flex-1 w-full flex overflow-hidden">
                    ...
                    <div className="flex items-centers justify-between py-2 px-3 text-xl font-medium">
                        My Conversation
                        <div
